...
typedef void (^CCProgressHUDCompletionBlock)(void);
 ...
 */
@property (strong, nonatomic, readonly) ZPBackgroundView *bezelView;

/**
 * View covering the entire HUD area, placed behind bezelView.
 */
@property (strong, nonatomic, readonly) ZPBackgroundView *backgroundView;
 ...
 */
@interface ZPRoundProgressView : UIView 
 ...
 */
@interface ZPBarProgressView : UIView
...
@interface ZPBackgroundView : UIView
...
/**
 * The blur effect style, when using CCProgressHUDBackgroundStyleBlur.
